...
% Zu spezifisch: Durch den modularen Aufbau ist es möglich die einzelnen Komponenten für die Audioverarbeitung zu nutzen.Das Framework ist modular aufgebaut und bietet eine Schnittstelle zur Audiohardware an, ermöglicht den Umgang mit RTP-Paketen, übernimmt das Encodieren und Dekodieren von Audiodaten ins RTP-Protokoll und stellt ein Jitterbuffer zur Verfügung. Sämtliche Funktionen wurden in einer Beispielanwendung integriert und getestet.

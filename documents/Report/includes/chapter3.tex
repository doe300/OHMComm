...
\subsection{RtAudio}
\label{sec:RtAudio}
Als Audiowrapper wird RtAudio eingesetzt. RtAudio wird entwickelt von Gary P. Scavone Professor an der McGill Uni in Kanada. RtAdudio dient als Programmierschnittstelle engl. Application Programming Interface(API) zwischen den Betriebssystemabhängigen API's und OHMComm. RtAudio unterstützt eine Vielzahl von API's. Aufgeschlüsselt nach Betriebssystem sind diese:

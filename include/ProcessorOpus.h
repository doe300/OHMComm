...
public:
	...
	//configure the Opus Processor, this creates OpusEncoder and OpusDecoderObject and initialises private variables: outputDeviceChannels, rtaudioFormat and ErrorCode

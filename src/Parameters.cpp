...
const Parameter* Parameters::SIP_CONFIGURATION = Parameters::registerParameter(Parameter(ParameterCategory::GENERAL, Parameter::FLAG_CONFIGURATION_MODE|Parameter::FLAG_HAS_VALUE, 's', "sip", "Enables signaling and configuration via SIP. The value is the remote SIP-port", "5060"));

...
const SupportedFormat* SupportedFormats::OPUS_48000 = SupportedFormats::registerFormat(SupportedFormat(PayloadType::OPUS, "opus", 48000, 2, AudioProcessorFactory::OPUS_CODEC, false, std::string(FORMAT_OPUS_DTX).append("=1; ").append(FORMAT_OPUS_FEC).append("=0")));
